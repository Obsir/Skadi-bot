...
from skadi.utils.plugin_utils import HttpFetcher
...
STICK_PATH = global_config.stick_path
...
async def sticker_maker_main(url: str, temp: str, text: str, sticker_temp_type: str):
    ...
    # 检查生成表情包路径
    sticker_folder_path = os.path.abspath(os.path.join(STICK_PATH, 'sticker'))
