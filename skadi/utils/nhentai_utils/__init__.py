...
from ..plugin_utils import HttpFetcher, create_7z_file
from ..bot_database import Result

global_config = get_driver().config
NHENTAI_PATH = global_config.nhentai_path
...
class NhentaiGallery(Nhentai):
    ...
    async def fetch_gallery(self) -> Result.DictResult:
        ...
        # 下载到公用临时目录
        file_path = os.path.abspath(os.path.join(NHENTAI_PATH, 'nhentai_gallery', str(self.gallery_id)))
