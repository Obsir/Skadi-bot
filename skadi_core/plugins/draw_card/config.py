...
DATA_PATH = Path(nonebot.get_driver().config.draw_card_data_path)
DATA_PATH.mkdir(parents=True, exist_ok=True)
DATA_PATH = str(DATA_PATH.absolute()) + '/'
DRAW_PATH = DATA_PATH
_draw_config = Path(rf"{DRAW_PATH}/draw_card_config/draw_card_config.json")

IMAGE_PATH = Path(os.path.join(nonebot.get_driver().config.draw_card_data_path, 'images'))
IMAGE_PATH.mkdir(parents=True, exist_ok=True)
IMAGE_PATH = str(IMAGE_PATH.absolute()) + '/'

TTF_PATH = Path(os.path.join(nonebot.get_driver().config.draw_card_data_path, 'fonts'))
