...
TXT_PATH = Path(os.path.join(nonebot.get_driver().config.buff_163_path, 'text'))
TXT_PATH.mkdir(parents=True, exist_ok=True)
TXT_PATH = str(TXT_PATH.absolute()) + '/'
PROXY_ADDRESS = nonebot.get_driver().config.proxy_address
PROXY_PORT = nonebot.get_driver().config.proxy_port
BUFF_PROXY = f'http://{PROXY_ADDRESS}:{PROXY_PORT}'
